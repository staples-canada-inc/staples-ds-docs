...
<!-- 
<ComponentPreview>
    <UncontrolledTooltip placement="top" target="UncontrolledTooltipExample1">Tooltip on top</UncontrolledTooltip>
    <UncontrolledTooltip placement="right" target="UncontrolledTooltipExample2">Tooltip on right</UncontrolledTooltip>
    <UncontrolledTooltip placement="bottom" target="UncontrolledTooltipExample3">Tooltip on bottom</UncontrolledTooltip>
    <UncontrolledTooltip placement="left" target="UncontrolledTooltipExample4">Tooltip on left</UncontrolledTooltip>
...
When triggered from hyperlinks that span multiple lines, tooltips will be centered. Use `white-space: nowrap;` on your `<a>` to avoid this behavior.
