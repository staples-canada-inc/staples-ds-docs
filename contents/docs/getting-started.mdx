...
These files are compiled with the required css and js code from [Bootstrap](https://getbootstrap.com). You can download these files by clicking the link below:

<Button href="#">Download Design System</Button>
...
```HTML
<!-- This is an example of the HTML code for creating an input text box -->
